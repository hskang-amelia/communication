...
pub trait Runtime {
    ...
    /// `MethodInArgAllocator` allocates pre-initialized argument slots for the zero-copy method call path
...
// Arity-0 unit tuple here and other arities 1+ are generated by `impl_all_arities!` in `method_arities_macros.rs`.
impl CommData for () {
    const ID: &'static str = "()";
}
